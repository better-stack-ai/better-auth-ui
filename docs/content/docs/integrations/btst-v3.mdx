...
The v3 release-candidate line uses the Better Auth 1.6.16 cohort retained by
...
`better-call` is 1.3.6. Keep those versions aligned exactly while evaluating
the release candidate. Do not combine this companion candidate with a Better
Auth 1.7 dependency graph.
